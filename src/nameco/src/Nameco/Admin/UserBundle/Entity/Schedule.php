...
class Schedule
{
     ...
     * Set ownerUser
     *
     * @param \Nameco\Admin\UserBundle\Entity\User $ownerUser
     * @return Schedule
     */
    public function setOwnerUser(\Nameco\Admin\UserBundle\Entity\User $ownerUser = null)
    {
     ...
     * Get ownerUser
     *
     * @return \Nameco\Admin\UserBundle\Entity\User 
     */
     ...
     * Add user
     *
     * @param \Nameco\Admin\UserBundle\Entity\User $user
     * @return Schedule
     */
    public function addUser(\Nameco\Admin\UserBundle\Entity\User $user)
    {
        $this->user[] = $user;
     ...
     * @param \Nameco\Admin\UserBundle\Entity\User $user
     */
    public function removeUser(\Nameco\Admin\UserBundle\Entity\User $user)
    {
     ...
     * Add establishment
     *
     * @param \Nameco\Admin\UserBundle\Entity\Establishment $establishment
     * @return Schedule
     */
    public function addEstablishment(\Nameco\Admin\UserBundle\Entity\Establishment $establishment)
    {
     ...
     * @param \Nameco\Admin\UserBundle\Entity\Establishment $establishment
     */
    public function removeEstablishment(\Nameco\Admin\UserBundle\Entity\Establishment $establishment)
    {
