...
class User implements UserInterface
{
     ...
     * Add bookmarkUser
     *
     * @param \Nameco\SecurityBundle\Entity\User $bookmarkUser
     * @return User
     */
    public function addBookmarkUser(\Nameco\SecurityBundle\Entity\User $bookmarkUser)
    {
     ...
     * @param \Nameco\SecurityBundle\Entity\User $bookmarkUser
     */
    public function removeBookmarkUser(\Nameco\SecurityBundle\Entity\User $bookmarkUser)
    {
