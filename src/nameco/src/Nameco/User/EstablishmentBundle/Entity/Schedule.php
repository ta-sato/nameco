...
class Schedule
{
     ...
     * @return Schedule
     */
    public function addEstablishment(\Nameco\User\EstablishmentBundle\Entity\Establishment $establishment)
    {
     ...
     * @param \Nameco\User\EstablishmentBundle\Entity\Establishment $establishment
     */
    public function removeEstablishment(\Nameco\User\EstablishmentBundle\Entity\Establishment $establishment)
    {
     ...
     * Add user
     *
     * @param \Nameco\User\EstablishmentBundle\Entity\User $user
     * @return Schedule
     */
    public function addUser(\Nameco\User\EstablishmentBundle\Entity\User $user)
    {
        $this->user[] = $user;
     ...
     * @param \Nameco\User\EstablishmentBundle\Entity\User $user
     */
    public function removeUser(\Nameco\User\EstablishmentBundle\Entity\User $user)
    {
     ...
     * Set ownerUser
     *
     * @param \Nameco\User\EstablishmentBundle\Entity\User $ownerUser
     * @return Schedule
     */
    public function setOwnerUser(\Nameco\User\EstablishmentBundle\Entity\User $ownerUser = null)
    {
     ...
     * Get ownerUser
     *
     * @return \Nameco\User\EstablishmentBundle\Entity\User 
     */
