...
class Schedule
{
     ...
     * Add user
     *
     * @param \Nameco\User\SchedulerBundle\Entity\User $user
     * @return Schedule
     */
    public function addUser(\Nameco\User\SchedulerBundle\Entity\User $user)
    {
        $this->user[] = $user;
     ...
     * @param \Nameco\User\SchedulerBundle\Entity\User $user
     */
    public function removeUser(\Nameco\User\SchedulerBundle\Entity\User $user)
    {
     ...
     * Set ownerUser
     *
     * @param \Nameco\User\SchedulerBundle\Entity\User $ownerUser
     * @return Schedule
     */
    public function setOwnerUser(\Nameco\User\SchedulerBundle\Entity\User $ownerUser = null)
    {
     ...
     * Get ownerUser
     *
     * @return \Nameco\User\SchedulerBundle\Entity\User 
     */
